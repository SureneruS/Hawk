...
/*	private void makeDestImage(){
			...
			for(int i=0; i < circles.cols();i++){
				...
				double x = circles.get(0, i)[0];
				double y = circles.get(0, i)[1];
				double rad = circles.get(0, i)[2];
				int radius = (int) Math.round(rad);
				
	 		 Point center = new Point(x,y);
	 		 Core.circle(dst, center, radius, new Scalar(0, 255, 0));
